...
WeixinRailsMiddleware.configure do |config|
  ...
  config.weixin_token_string = 'aab1c31be8cfb2db38854a3e'
  # using to weixin server url to validate the token can be trusted.
  config.weixin_secret_string = 'o4PYshOeKW2EXPVYcKyypyuuUhtgSC8n'
  # 加密配置，如果需要加密，配置以下参数
  # config.encoding_aes_key = '883051273535b6ce602277d618fb866f8686486c71d'
